...
public enum AccessFlag {
     ...
     */
    ACC_PUBLIC(0x0001, JavaLangSpec.Keyword.PUBLIC.keyword),
    /**
     * Declared <code>private</code>; usable only within the defining class.
     */
    ACC_PRIVATE(0x0002, JavaLangSpec.Keyword.PRIVATE.keyword),
    /**
     * Declared <code>protected</code>; may be accessed within subclasses.
     */
    ACC_PROTECTED(0x0004, JavaLangSpec.Keyword.PROTECTED.keyword),
    /**
     * Declared <code>static</code>.
     */
    ACC_STATIC(0x0008, JavaLangSpec.Keyword.STATIC.keyword),
    /**
     * Declared <code>final</code>; no subclasses allowed.
     */
    ACC_FINAL(0x0010, JavaLangSpec.Keyword.FINAL.keyword),
    /**
     ...
     */
    ACC_SUPER(0x0020, JavaLangSpec.Keyword.SUPER.keyword),
    /**
     * Declared <code>synchronized</code>; invocation is wrapped by a monitor
     * use.
     */
    ACC_SYNCHRONIZED(0x0020, JavaLangSpec.Keyword.SYNCHRONIZED.keyword),
    /**
     ...
     */
    ACC_VOLATILE(0x0040, JavaLangSpec.Keyword.VOLATILE.keyword),
    /**
     ...
     * object manager.
     */
    ACC_TRANSIENT(0x0080, JavaLangSpec.Keyword.TRANSIENT.keyword),
    /**
     ...
     */
    ACC_NATIVE(0x0100, JavaLangSpec.Keyword.NATIVE.keyword),
    /**
     * Is an interface, not a class.
     */
    ACC_INTERFACE(0x0200, JavaLangSpec.Keyword.INTERFACE.keyword),
    /**
     * Declared <code>abstract</code>; must not be instantiated.
     */
    ACC_ABSTRACT(0x0400, JavaLangSpec.Keyword.ABSTRACT.keyword),
    /**
     * Declared <code>strictfp</code>; floating-point mode is FP-strict.
     */
    ACC_STRICT(0x0800, JavaLangSpec.Keyword.STRICTFP.keyword),
    /**
     ...
     */
    ACC_ENUM(0x4000, JavaLangSpec.Keyword.ENUM.keyword),
    /**
