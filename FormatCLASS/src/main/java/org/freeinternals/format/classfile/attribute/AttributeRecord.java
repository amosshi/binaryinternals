...
public class AttributeRecord extends AttributeInfo {
    ...
    AttributeRecord(final u2 nameIndex, final String type, final PosDataInputStream stream, final CPInfo[] cp) throws IOException, FileFormatException {
    ...
    public static final class record_component_info extends FileComponent implements GenerateClassfileTreeNode {
        ...
        private record_component_info(final PosDataInputStream stream, final CPInfo[] cp) throws IOException, FileFormatException {
            ...
            if (this.attributes_count.value > 0) {
                ...
                for (int i = 0; i < this.attributes_count.value; i++) {
                    this.attributes[i] = AttributeInfo.parse(stream, cp);
                }
            } else {
