...
public class AttributeModuleHashes extends AttributeInfo {
    ...
    /**
     * The value of the {@link #hashes_count} item indicates the number of entries in
     * the {@link #hashes} table.
     */
    public transient final u2 hashes_count;
    public transient final Hashes[] hashes;

    AttributeModuleHashes(final u2 nameIndex, final String type, final PosDataInputStream posDataInputStream)
