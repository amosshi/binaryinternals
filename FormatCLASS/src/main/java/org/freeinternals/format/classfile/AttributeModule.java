...
public class AttributeModule extends AttributeInfo {
    ...
    public final class Exports extends FileComponent {
        ...
        private Exports(final PosDataInputStream posDataInputStream)
                throws IOException {
            this.startPos = posDataInputStream.getPos();
    ...
    public final class Opens extends FileComponent {
        ...
        private Opens(final PosDataInputStream posDataInputStream)
                throws IOException {
            this.startPos = posDataInputStream.getPos();
    ...
    public final class Provides extends FileComponent {
        ...
        private Provides(final PosDataInputStream posDataInputStream)
                throws IOException {
            this.startPos = posDataInputStream.getPos();
